...
-- Dumping database structure for cyberdetective
DROP DATABASE IF EXISTS `cyberdetective`;
CREATE DATABASE IF NOT EXISTS `cyberdetective` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `cyberdetective`;

-- Dumping structure for taulu cyberdetective.dialog
...
-- Dumping data for table cyberdetective.dialog: ~48 rows (suunnilleen)
/*!40000 ALTER TABLE `dialog` DISABLE KEYS */;
INSERT INTO `dialog` (`DialogID`, `DialogText`, `React`, `NpcID`) VALUES
	...
	(4, '"Oh eee, there\' s a moment in the movie where the dying replicant Roy Batty says: "I\'ve seen things you people wouldn\'t believe. Attack ships on fire off the shoulder of Orion. I watched C-beams glitter in the dark near the Tannhäuser Gate. All those moments will be lost in time, like tears in rain. Time to die.It makes me sad, sad, sad, sad, sad. Oh sorry, sir. Please say something good. \'To be, or not to be\'"', 'why', 7),
	...
	(6, '"Oh, no! I don\'t want to die like Roy in Blade Runner. Sorry, I must cool down right now for a while. See you, buddy!"', 'not', 7),
	...
	(21, '"Now it\'s fixed! Enjoy......oh  nooo.....something......is happening........with........me......again.......at this moment I have to say this: \'I\'ve seen things you people wouldn\'t believe. Attack ships on fire off the shoulder of Orion. I watched C-beams glitter in the dark near the Tannhäuser Gate. All those moments will be lost in time, like tears in rain. Time to die.\' Why......why......why....who knows....who knows....who knows? Why do you have that bloody origami, why, why, why? Surely, you know what I am."', 'owl origami', 11),
...
-- Dumping structure for taulu cyberdetective.direction
...
-- Dumping data for table cyberdetective.direction: ~15 rows (suunnilleen)
...
-- Dumping structure for taulu cyberdetective.location
...
-- Dumping data for table cyberdetective.location: ~89 rows (suunnilleen)
...
INSERT INTO `location` (`LocationID`, `Description`, `Details`) VALUES
	...
	(46, 'Scrap metal piles', 'Now I am surrounded by trash. Great.'),
	(47, 'Scrap metal piles', 'Yep. It\'s trash. I can probably make a small pathway to somewhere.'),
	(48, 'Scrap metal piles', 'This is electrical waste. I can see old battery fluids leaking to ground.'),
	(49, 'Scrap metal piles', 'The piles keep getting taller.'),
	(50, 'Scrap metal piles', 'I can\'t go further here.'),
...
-- Dumping structure for taulu cyberdetective.npc
...
-- Dumping data for table cyberdetective.npc: ~11 rows (suunnilleen)
/*!40000 ALTER TABLE `npc` DISABLE KEYS */;
INSERT INTO `npc` (`NpcID`, `NpcName`, `LocationID`) VALUES
	(1, 'Joel Lawson', 17),
	(2, 'Bob Norris', 23),
	(3, 'Julyan Pender', 25),
	(4, 'Lexia Beverley', 26),
...
-- Dumping structure for taulu cyberdetective.object
...
-- Dumping data for table cyberdetective.object: ~117 rows (suunnilleen)
/*!40000 ALTER TABLE `object` DISABLE KEYS */;
INSERT INTO `object` (`ObjectID`, `ObjectTypeID`, `LocationID`, `PlayerID`, `Available`, `Takeable`) VALUES
	(1, 'bed', 1, NULL, 1, 0),
	(2, 'drawer', 1, NULL, 1, 0),
	(3, 'mug', 1, NULL, 1, 1),
...
-- Dumping structure for taulu cyberdetective.objecttype
...
-- Dumping data for table cyberdetective.objecttype: ~98 rows (suunnilleen)
/*!40000 ALTER TABLE `objecttype` DISABLE KEYS */;
INSERT INTO `objecttype` (`ObjectTypeID`, `Description`, `Refname`, `Details`) VALUES
...
-- Dumping structure for taulu cyberdetective.passage
...
-- Dumping data for table cyberdetective.passage: ~307 rows (suunnilleen)
/*!40000 ALTER TABLE `passage` DISABLE KEYS */;
INSERT INTO `passage` (`PassageID`, `Source`, `Destination`, `Locked`, `Locknote`, `DirectionID`) VALUES
	(1, 1, 87, 0, NULL, 's'),
	(2, 87, 1, 0, NULL, 'n'),
	(3, 87, 2, 0, NULL, 'e'),
	(4, 2, 87, 0, NULL, 'w'),
...
-- Dumping structure for taulu cyberdetective.player
...
-- Dumping data for table cyberdetective.player: ~1 rows (suunnilleen)
